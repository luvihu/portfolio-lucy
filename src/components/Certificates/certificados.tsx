...
export const certificados = [
  ...
  {
    image: '/assets/certf-desWeb.png',
    text: 'Certificado Desarrollo Web',
    description: 'La introducción al desarrollo web me brindó una base sólida para la creación y diseño de páginas web, haciendo uso de HTML, CSS y JavaScript.'
  },
  {
