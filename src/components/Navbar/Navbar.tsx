...
export function Navbar() {
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between w-full px-4 py-3 md:py-5 md:flex-row md:justify-center gap-x-20 md:px-4 md:h-max bg-white/10 backdrop-blur-sm md:rounded-full">
                ...
                <Link href="/assets/CvLucyVillogas.pdf" passHref legacyBehavior>
                  <a target="_blank" rel="noopener noreferrer" className="flex items-center "><RiFileTextLine size="30" />
